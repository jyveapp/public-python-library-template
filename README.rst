...
A new public python package can be started with::
    ...
    pip3 install temple
    temple setup git@github.com:jyveapp/public-python-library-template.git
...
``temple ls git@github.com:jyveapp/public-python-library-template.git`` to see a list of
all projects spun up with this template for examples at Jyve.
...
other Python packages at Jyve, all the way from local development to
